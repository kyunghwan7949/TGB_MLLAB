...
class LinkPropPredDataset(object):
    def __init__(
        ...
        Args:
            ...
            meta_dict:(negative sampling) dictionary containing meta information about the dataset, should contain key 'dir_name' which is the name of the dataset folder
        ...
        if "fname" not in self.meta_dict:
            ...
            # self.meta_dict["fname"] = self.root + "/" + self.name + "_edgelist_head100.csv"
