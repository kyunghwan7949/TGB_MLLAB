...
def get_link_prediction_args(is_evaluation: bool = False):
    ...
    parser.add_argument('--dataset_name', type=str, help='dataset to be used', default='tgbl-flight',
                        choices=['wikipedia', 'reddit', 'mooc', 'lastfm', 'enron', 'SocialEvo', 
                                 ...
                                 'tgbl-wiki', 'tgbl-review', 'tgbl-flight','tgbl-comment','tgbl-coin'])
    parser.add_argument('--adj_list_name', type=str, help='dataset to be used', default='tgbl-wiki',
                        choices=['wikipedia', 'reddit', 'mooc', 'lastfm', 'enron', 'SocialEvo', 
                                 'uci', 'Flights', 'CanParl', 'USLegis', 'UNtrade', 'UNvote', 'Contacts',
                                 'amazonreview', 'stablecoin', 'opensky', 'redditcomments',
                                 'tgbl-wiki', 'tgbl-review', 'tgbl-flight'])
    parser.add_argument('--batch_size', type=int, default=200, help='batch size')
    parser.add_argument('--model_name', type=str, default='TokenGT', help='name of the model, note that EdgeBank is only applicable for evaluation',
                        choices=['JODIE', 'DyRep', 'TGAT', 'TGN', 'CAWN', 'EdgeBank', 'TCL', 'GraphMixer', 'DyGFormer','TokenGT','TokenGT_Time'])
    ...
    parser.add_argument('--time_feat_dim', type=int, default=172, help='dimension of the time embedding')
    ...
    parser.add_argument("--encoder-ffn-embed-dim", type=int, default=172,  metavar="N", help="encoder embedding dim for FFN")
    ...
    parser.add_argument("--encoder-embed-dim", type=int, default=172, metavar="N", help="encoder embedding dimension")
