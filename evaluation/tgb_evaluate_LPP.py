...
# def query_pred_edge_batch_tmp(model_name: str, model: nn.Module, 
...
#                                                                 dst_node_ids=dst_node_ids,
#                                                                 node_interact_times=node_interact_times)
#     elif model_name in ['TokenGT']:
#         # get temporal embedding of source and destination nodes
#         # two Tensors, with shape (batch_size, node_feat_dim)
#         batch_src_node_embeddings, batch_dst_node_embeddings = \
#             model[0].compute_src_dst_static_graph_embeddings(src_node_ids=src_node_ids,
#                                                                 dst_node_ids=dst_node_ids,
#                                                                 node_interact_times=node_interact_times)
#     else:
...
# def query_neg_stack_pred_edge_batch_tmp(model_name: str, model: nn.Module, 
#                           src_node_ids: int, dst_node_ids: int, node_interact_times: float, edge_ids: int,
#                           edges_are_positive: bool, num_neighbors: int, time_gap: int):
#     """
#     query the prediction probabilities for a batch of edges
...
#         model[0].compute_neg_stack_src_dst_static_graph_embeddings(src_node_ids=src_node_ids,
#                                                                 dst_node_ids=dst_node_ids,
#                                                                 node_interact_times=node_interact_times)
        
#     return batch_neg_src_node_embeddings, batch_neg_dst_node_embeddings

# # def query_neg_pred_edge_batch(model_name: str, model: nn.Module, 
# #                           src_node_ids: int, dst_node_ids: int, node_interact_times: float, edge_ids: int,
# #                           edges_are_positive: bool, num_neighbors: int, time_gap: int):
# #     """
# #     query the prediction probabilities for a batch of edges
# #     """
# #     batch_neg_src_node_embeddings, batch_neg_dst_node_embeddings = \
# #                     model[0].compute_neg_src_dst_static_graph_embeddings(src_node_ids=src_node_ids,
# #                                                                             dst_node_ids=dst_node_ids,
# #                                                                             node_interact_times=node_interact_times)
...
#     if model_name in ['DyRep', 'TGAT', 'TGN', 'CAWN', 'TCL', 'GraphMixer', 'DyGFormer','TokenGT']:
...
#                 # negative edges (999개)
#                 # batch_neg_src_node_embeddings, batch_neg_dst_node_embeddings = \
#                 #     query_neg_pred_edge_batch(model_name=model_name, model=model, 
...
#                 batch_neg_src_node_embeddings, batch_neg_dst_node_embeddings = \
#                     query_neg_stack_pred_edge_batch(model_name=model_name, model=model, 
#                           src_node_ids=batch_neg_src_node_ids, dst_node_ids=batch_neg_dst_node_ids, 
#                           node_interact_times=batch_neg_node_interact_times, edge_ids=None,
#                           edges_are_positive=False, num_neighbors=num_neighbors, time_gap=time_gap)
    ...
    if model_name in ['TGAT', 'CAWN', 'TCL']:
        ...
        batch_src_node_embeddings, batch_dst_node_embeddings = \
            model[0].compute_src_dst_node_temporal_embeddings(src_node_ids=src_node_ids,
                                                                dst_node_ids=dst_node_ids,
                                                                node_interact_times=node_interact_times)
    elif model_name in ['TokenGT','TokenGT_Time','TokenGT_Time_one_pair']:
        # get temporal embedding of source and destination nodes
        # two Tensors, with shape (batch_size, node_feat_dim)
        batch_src_node_embeddings, batch_dst_node_embeddings = \
            model[0].batch_compute_src_dst_static_graph_embeddings(src_node_ids=src_node_ids,
                                                                dst_node_ids=dst_node_ids,
                                                                node_interact_times=node_interact_times)
